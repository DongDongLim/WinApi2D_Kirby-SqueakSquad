// KirbySqueakSquad.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#include "framework.h"
#include "KirbySqueakSquad.h"
#include "locale.h"
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_KIRBYSQUEAKSQUAD, szWindowClass, MAX_LOADSTRING);
    ...
    // 단축키 정보
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_KIRBYSQUEAKSQUAD));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_KIRBYSQUEAKSQUAD));   // 프로그램 아이콘
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
    ...
    rc.left = 0;
    rc.top = 0;
    rc.right = WINSIZEX * ZOOM ;
    rc.bottom = WINSIZEY * ZOOM ;
